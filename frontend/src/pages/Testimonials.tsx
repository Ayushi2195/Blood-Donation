...
export default function Testimonials() {
  ...
  return (
    <div className={`flex flex-col items-center min-h-screen px-4 py-12 bg-gradient-to-b from-rose-150 to-rose-200 transition-all duration-700 ease-out w-screen ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}
    ...
    >
      ...
      <section className="w-full max-w-3xl mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {partners.map((p) => (
              <div key={p.name} className="bg-gray-50 rounded shadow p-4 flex flex-col items-center text-center">
      ...
      <section className="w-full max-w-3xl mb-12">
          ...
          <div className="bg-gray-50 rounded shadow p-4 flex flex-col gap-4">
      ...
      <section className="w-full max-w-3xl mb-12">
        ...
        <div className="flex flex-wrap gap-6 justify-center">
          {awards.map((a) => (
              <div key={a.name} className="flex flex-col items-center bg-gray-50 rounded shadow p-4 min-w-[160px]">
      ...
      <section className="w-full max-w-2xl mb-12">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 bg-gray-50 rounded shadow p-6">
      ...
      <section className="w-full max-w-2xl mb-12">
          ...
          <div className="bg-gray-50 rounded shadow p-6 h-24 flex items-center justify-center text-lg font-semibold text-pink-600 animate-pulse min-h-[4rem]">
